        ...
        <div className={stl.start__body}>
          <div className={stl.start__column}>
            <motion.h2 {...motionProps} className={stl.start__title}>
              Ready to scale your business with Affiliate Marketing &amp; Google Ads?
            </motion.h2>
            <motion.p
              {...motionProps}
            ...
            >
              Contact Axantra Consult Limited today to start driving measurable results and maximizing your ROI.
            </motion.p>
          </div>
          <div className={stl.start__column}>
            <motion.div
            ...
            >
              ...
              <a href="mailto:main@axantramedia.com" className={stl.start__link}>
